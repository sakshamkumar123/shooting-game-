    ...
    play(){
        ...
        var y ;
            for (var plr in allPlayers){
               ...
               fill("black")
               textSize(30)
               text("score 100 points to win",width/2,height/2-height/4)
               text("press space  to  shoot ",width/2,height/2-height/5)
            ...
            console.log(player.points)
                ...
                if (keyWentDown("space")){
                    ...
                    if(index===1){
                    bullet  = createSprite(players[index-1].x+20,players[index-1].y,5,5)
                    ...
                    if(index===2){
                    bullet2  = createSprite(players[index-1].x-20,players[index-1].y,5,5)
